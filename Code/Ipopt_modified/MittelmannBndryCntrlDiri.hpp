...
/** Implemention of Example Custom */
class MittelmannBndryCntrlDiriCustom: public MittelmannBndryCntrlDiriBase
{
public:
   MittelmannBndryCntrlDiriCustom()
   { }

   virtual ~MittelmannBndryCntrlDiriCustom()
   { }
...
private:
   ...
   //@{
   MittelmannBndryCntrlDiriCustom(
      const MittelmannBndryCntrlDiriCustom&
   );

   MittelmannBndryCntrlDiriCustom& operator=(
      const MittelmannBndryCntrlDiriCustom&
   );
   //@}
