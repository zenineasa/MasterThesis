...
from networks import InitGuessNetwork
    ...
    if TRAINING_MODE:
        ...
        for epoch in tqdm(range(NUM_EPOCHS)):
            ...
            for _ in range(NUM_GRADIENT_ACCUMULATION_STEPS):
                ...
                guessBVal = model(array[:, 1:-1, 1:-1], bounds, d_const)

                # Calculate the loss
                loss = loss_fn(guessBVal, array, bounds, d_const, u_init, alpha)
                loss.backward()
